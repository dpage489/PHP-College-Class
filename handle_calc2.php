...
<head>
  ...
  <style type="text/css">
     .number { front-weight: bold; }
  </style>
</head>
<body>
<?php // Script 4.2 - handle_calc.php
/* This script takes value from calculator.html and performs
total cost and motthly payment calculations.*/
...
Divided over<span class=\"number\">$payments</span> monthly payments, that would be $<span class=\"numbber\">$monthly</span> each.</p>";
